...
- Best speeds can be obtained by by using a fast MCU. The ESP8266 has a higher clock-speed than an ATmega328. Note however that using a higher speed may be unstable. The PCF8574 datasheet mentions 100kHz as maximum, but testing showed higher speeds are possible. See [this issue](maxint-rd/mxUnifiedPCD8544_Nokia_5110_LCD#2) for full details.
